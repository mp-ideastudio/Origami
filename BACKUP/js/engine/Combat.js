...
handleHaltedAttack() {
            ...
            spawnProjectile(action, spellData) {
                ...
                if (spellData && ['EARTH', 'FIRE', 'WIND', 'WATER'].includes(spellData.el)) {
                    ...
                    // 32 segments makes it perfectly smooth instead of blocky.
                    ...
                    projectileMesh.add(starMesh, trail);
                ...
                projectileMesh.userData = Object.assign(projectileMesh.userData || {}, {
                    ...
                    dmg: spellData ? (spellData.dmgMin ? Math.floor(Math.random() * (spellData.dmgMax - spellData.dmgMin + 1)) + spellData.dmgMin : spellData.dmg) : 25,
                    active: true,
