...
animate() {
                ...
                for (let bi = this.boulders.length - 1; bi >= 0; bi--) {
                    ...
                    if (b.userData.spellState === 'FLYING') {
                        ...
                        if (b.userData.isEarth || b.userData.isBoulder) {
                            ...
                            if (b.userData.isArrow) {
                                const dir = new THREE.Vector3(b.userData.vX, b.userData.vY, b.userData.vZ).normalize();
                        ...
                        if (b.userData.age % 0.05 < delta) { 
                            ...
                            if (b.userData.isArrow || b.userData.isShuriken) {
                                ...
                                const streak = new THREE.Mesh(new THREE.PlaneGeometry(0.1, 0.6), this._sharedParticleMats.WIND);
                                streak.position.copy(b.position);
                                streak.rotation.copy(b.rotation);
                                streak.userData = { isRockFrag: true, vY: 0, vX: 0, vZ: 0, rX: 0, rY: 0, rZ: 0, life: 12 };
                    ...
                    } else if ((b.userData.isArrow || b.userData.isShuriken) && b.position.y >= 2.9 && b.userData.vY > 0) {
                                    ...
                                    if (b.userData.isShuriken || b.userData.type === 'SHURIKEN' || b.userData.isArrow) {
                                        ...
                                        if (b.userData.isShuriken || b.userData.isArrow) {
                                            ...
                                            if (stuckProj) {
                                                ...
                                                const dirToProj = new THREE.Vector3().subVectors(b.position, child.position);
                                                ...
                                                const worldQuat = b.getWorldQuaternion(new THREE.Quaternion());
                                                // Remove the parent's rotation to get the correct local rotation
                                                const parentQuat = child.getWorldQuaternion(new THREE.Quaternion()).invert();
